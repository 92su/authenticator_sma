...
authenticator =  stauth.Authenticate(names,usernames,hashed_passwords,"sales_dashboard","abcdef",cookie_expiry_days=30) # https://github.com/Sven-Bo/streamlit-sales-dashboard-with-userauthentication/issues/1
